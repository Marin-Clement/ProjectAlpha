...
public class DungeonManager : MonoBehaviour
{
    ...
    // Dungeon UI
    [Header("Dungeon UI")] [SerializeField]
    ...
    [Space(20), Header("Dungeon Generation")] [SerializeField]
    private int rooms;
    ...
    private void GenerateDungeonLayout()
    {
        ...
        if (debug)
        {
            Debug.Log("<color=green>Generated dungeon layout in " + ((Time.realtimeSinceStartup - startTime) * 1000) +
                      "ms</color>");
    ...
    {
        return _roomsLayout[(int)generationPosition.x + (int)direction.x,
            (int)generationPosition.y + (int)direction.y] == null;
    }
